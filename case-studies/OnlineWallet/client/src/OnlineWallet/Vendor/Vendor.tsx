...
export default class Session extends React.Component<Props, Partial<Transport>> {
    ...
    render() {
        ...
        return ws === undefined
            ? this.props.waiting
            : <Vendor ws={ws} {...this.props} />;
    }

}

class Vendor extends React.Component<Props & Transport, ComponentState> {
    ...
    constructor(props: Props & Transport) {
        ...
        this.state = {
            elem: props.waiting,
            state: ReceiveState.S0

        };

        // Set up message and handler queues
        this.messageQueue = {
            [Roles.Peers.Wallet]: [], [Roles.Peers.Customer]: [],
        };
        this.handlerQueue = {
            [Roles.Peers.Wallet]: [], [Roles.Peers.Customer]: [],
        };
